...
Atualizar somente o campo `status` do projeto `data-center` em `conteudo/projetos/projetos.json`. Nenhum contrato, enum ou schema novo será criado, pois `ativo` já expressa corretamente o estado operacional.

### Página de detalhe

Remover o bloco de badges localizado entre o breadcrumb e o título em `app/projetos/[slug]/page.tsx`.
