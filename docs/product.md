...
O corpo público usa documentos editoriais versionados V1, V2 e V3: parágrafos, H2/H3, listas, citações, imagens prontas, vídeo MP4 top-level, negrito, itálico e links seguros. A prévia usa o mesmo renderer da matéria pública, mas fica isolada à revisão autorizada, sem canonical, JSON-LD, compartilhamento ou indexação, e oferece uma saída explícita do Draft Mode.
