...
describe("RelatedProjectsDiscovery", () => {
  it("centraliza um card compacto com o NITE Discovery Frame", () => {
    ...
    expect(section).toHaveClass("bg-nite-background", "text-nite-text-primary");
  ...
  it("define tokens locais do NITE Discovery Frame sem literais dark-first no TSX", () => {
    ...
    expect(styles).toContain(
      "--related-card-border: var(--nite-border-subtle);",
    );
    ...
    expect(styles).toContain(
      ':root[data-theme="dark"] .relatedProjectsDiscovery',
    );
    expect(styles).toContain(
    ...
    expect(styles).toContain(
      ':root[data-theme="light"] .relatedProjectsDiscovery',
    );
