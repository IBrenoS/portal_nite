...
const logoSvg = readFileSync(
  join(process.cwd(), "public/brand/nite/logo_final.svg"),
  "utf8",
)
  .replace('<?xml version="1.0" encoding="UTF-8"?>', "")
  .replace(
    '<svg id="logo-final"',
    '<svg id="logo-final" role="img" aria-labelledby="animated-nite-logo-title"',
  )
  .replace(
    "<defs>",
  ...
  .replace(
    '<g id="nite-logo">',
    '<title id="animated-nite-logo-title">Logo do NITE</title><g id="nite-logo">',
  )
