...
import type { Project } from "@nite/content";
...
describe("ProjectsPage", { timeout: 10_000 }, () => {
  it("renderiza a pagina como Explorer/Catalogo, sem repetir a vitrine da Home", () => {
    ...
    expect(main.getByRole("link", { name: /Data Center/i })).toHaveAttribute(
      "href",
      "/projetos/data-center",
    );
    expect(
    ...
    expect(
      embeddedGamesCard?.querySelector("img")?.getAttribute("src"),
