...
export function NiteSymbol({ className, title, ...props }: NiteSymbolProps) {
  ...
  return (
    ...
    >
      ...
      <circle cx="26.86" cy="27.73" r="1.78" fill="currentColor" opacity="0.9" />
      <circle cx="37.14" cy="27.73" r="1.78" fill="currentColor" opacity="0.9" />
      <circle cx="26.86" cy="32.78" r="1.45" fill="#F4F8FB" opacity="0.72" />
      <circle cx="37.14" cy="32.78" r="1.45" fill="#F4F8FB" opacity="0.72" />
      <path
